    ...
    <div className="max-w-6xl mx-auto py-16">
      ...
      <div className="lg:relative z-20 flex flex-col lg:flex-row justify-around items-center gap-4 px-4 lg:px-32">
        <div className="absolute top-[250px] z-50 w-full lg:flex hidden">
          <div className="absolute left-10 border border-[#2C9CF0]" style={{width:"36.75px",height:"49px",display:"flex",justifyContent:"center",alignItems:"center"}}>
            <MdKeyboardArrowLeft className="text-5xl text-[#2C9CF0]" />
          </div>
          <div className="absolute right-10 border py-3 px-0.5 border-[#2C9CF0]" style={{width:"36.75px",height:"49px",display:"flex",justifyContent:"center",alignItems:"center"}}>
        ...
        <div className="relative w-full lg:w-[238px] bg-white dark:bg-[#818A97] p-2 border">
          ...
          <div className="font-poppins mt-12">
            ...
            <div className="w-full">
              ...
              <p className="py-2 text-[14px] font-inter text-[#525965] font-[400] text-center dark:text-[#DFDFDF]">
        ...
        <div className="relative w-full lg:w-[238px] bg-white dark:bg-[#818A97] p-2 border">
          ...
          <div className="font-poppins mt-12">
            ...
            <div className="w-full">
              ...
              <p className="py-2 text-[14px] text-[#525965] font-inter font-[400]  text-center dark:text-[#DFDFDF]">
                Las Vegas Ballpark, Las Vegas, Nevada
              </p>
              {/* button */}
              <div className="w-full flex justify-center py-2">

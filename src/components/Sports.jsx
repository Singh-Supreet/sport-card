  ...
  return (
    <div className="max-w-6xl mx-auto py-16">
      <div className="px-4 lg:px-0 mb-8 flex flex-row  justify-between items-center">
        <div>
          <h1
            className="font-[700] dark:text-white"
            style={{
              fontFamily: "Poppins",
              fontSize: "24px",
              lineHeight: "36px",
        ...
        <div className="">
          <button
            ...
            className="text-3xl w-full py-4  dark:text-white flex gap-2"
          >
          ...
          <div className="font-inter">
            ...
            <div className="flex flex-row justify-between bg-[#F7F7F8] dark:bg-[#292B32] p-2">
              <div className="space-y-1">
                ...
                <h2 className="text-[14px] dark:text-white font-[500]">
                  48 Events
                </h2>
              </div>
              <div className="space-y-1">
          ...
          <div className="font-inter">
            ...
            <div className="flex flex-row justify-between bg-[#F7F7F8] dark:bg-[#292B32] p-2">
              <div className="space-y-1">
                ...
                <h2 className="text-[14px] dark:text-[#DFDFDF] font-[500]">
                  28 Events
                </h2>
              </div>
              <div className="space-y-1 ">
      ...
      <div className="py-10 flex justify-center">
        <button className="bg-[#2C9CF0] text-white px-6 py-2" style={{width:"124.8px",borderRadius:"3px", padding:"10px 30px", height:"46px"}}>
          <p style={{width:"64px", height:"26px", fontSize:"14px", fontFamily:"inter",fontWeight:"600",lineHeight:"25.83px"}} >See More</p>
        </button>
      </div>
    </div>
  );
